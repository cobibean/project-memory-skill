...
The point is simple: help future Codex, Claude, and other coding-agent sessions recover decisions, constraints, verification, and next actions without rereading the whole repo from scratch.
...
Copy `SKILL.md` into your agent skills folder or into any skill-distribution mechanism your agent supports.
...
You can also copy the convention into a repo-level `AGENTS.md`, `CLAUDE.md`, or contributor guide if that is how your project gives agents instructions.
...
For SaaS/product repos, capture scope decisions, schema/API changes, auth or billing constraints, migrations, and verification commands.
